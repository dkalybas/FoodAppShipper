...
import com.example.newfoodapp_shipper.ShippingActivity;
...
public class MyShippingOrderAdapter  extends RecyclerView.Adapter<MyShippingOrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        //Here we jsut disable button if already started to ship
        if(shippingOrderModelList.get(position).isStartTrip()){

            holder.btn_ship_now.setEnabled(true);
        }

        //Here is the Event for Maps
